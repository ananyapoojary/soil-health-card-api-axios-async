    ...
    <Container maxWidth="xl">
      <Grid container spacing={5} alignItems="center" justifyContent="center" py={3}>
        ...
        <Grid item xs={12} md={5} display="flex" justifyContent={isSmallScreen ? "center" : "flex-end"} alignItems="center">
          ...
          <Button variant="text" color="secondary" sx={{ mx: 2 }} onClick={() => navigate("/about")}>
            About Us
          </Button>
          <Button variant="text" color="secondary" sx={{ mx: 2 }} onClick={() => navigate("/contact")}>
            Contact Us
          </Button>
          <Button variant="text" color="secondary" sx={{ mx: 2 }} onClick={handleMenuClick}>
            Related Links
          </Button>
